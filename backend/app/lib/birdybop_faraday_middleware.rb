# The `faraday_middleware` gem does not support Faraday versions > 2.x, so this
# is mostly a copy-and-paste straight from `FaradayMiddleware::FollowRedirects`,
# which can be found here:
# https://github.com/lostisland/faraday_middleware/blob/d7d252ca88a113285bc3a9500fbf6c40cb360a97/lib/faraday_middleware/response/follow_redirects.rb

# class BirdybopFaradayMiddleware::FollowRedirects # for searching
module BirdybopFaradayMiddleware
